...
;main.c,38 :: 		TRISD=0;            // Define todos os pinos do PORTD como saída.
	CLRF        TRISD+0 
...
L_main0:
;main.c,40 :: 		PORTD=0;         // Todos os pinos do PORTD em 0.
	CLRF        PORTD+0 
...
L_main2:
	...
	NOP
	NOP
;main.c,42 :: 		PORTD=255;       // Todos os pinos do PORTD em 1.
	MOVLW       255
	MOVWF       PORTD+0 
