...
********************************************************************************
 PROGRAMA EXEMPLO: Utilizar timer3 para incrementar contador de 0 a 9999.
...
void main(){
   ...
   PIR2.TMR3IF = 0;       // Apaga flag de estouro do timer0, pois é fundamental para a sinalização do estouro.
