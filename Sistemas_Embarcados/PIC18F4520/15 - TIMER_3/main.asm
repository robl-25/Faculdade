...
;main.c,63 :: 		T3CON.RD16 = 1;          // Habilita a leitura e escrita em um ciclo de 16 bits.
	BSF         T3CON+0, 7 
;main.c,64 :: 		T3CON.T1CKPS1 = 1;       // Define prescaler 1:8.
	BSF         T3CON+0, 5 
;main.c,65 :: 		T3CON.T1CKPS0 = 1;       // Define prescaler 1:8.
	BSF         T3CON+0, 4 
;main.c,66 :: 		T3CON.TMR3CS = 0;        // Clock interno.
	BCF         T3CON+0, 1 
;main.c,69 :: 		TMR3H = 0x0B;            // Carrega o valor alto do número 3036.
	MOVLW       11
	MOVWF       TMR3H+0 
;main.c,70 :: 		TMR3L = 0xDC;            // Carrega o valor baixo do numero 3036.
	MOVLW       220
	MOVWF       TMR3L+0 
;main.c,72 :: 		PIR2.TMR3IF = 0;       // Apaga flag de estouro do timer0, pois é fundamental para a sinalização do estouro.
	BCF         PIR2+0, 1 
;main.c,73 :: 		T3CON.TMR3ON = 1;      // Liga timer3.
	BSF         T3CON+0, 0 
...
L_main0:
;main.c,78 :: 		if(PIR2.TMR3IF==1){   // Incrementa somente quando existir o overflow do timer 3.
	BTFSS       PIR2+0, 1 
	GOTO        L_main2
;main.c,80 :: 		TMR3H = 0x0B;           // Carrega o valor alto do número 3036.
	MOVLW       11
	MOVWF       TMR3H+0 
;main.c,81 :: 		TMR3L = 0xDC;           // Carrega o valor baixo do numero 3036.
	MOVLW       220
	MOVWF       TMR3L+0 
;main.c,83 :: 		PIR2.TMR3IF = 0;        // Limpa o flag de estouro do timer0 para uma nova contagem de tempo.
	BCF         PIR2+0, 1 
