...
;main.c,68 :: 		T0CON.T08BIT = 0;        // Define contagem no modo 16 bits.
	BCF         T0CON+0, 6 
;main.c,70 :: 		TMR0H = 0xE1;            // Carrega o valor alto do número 57723.
	MOVLW       225
	MOVWF       TMR0H+0 
;main.c,71 :: 		TMR0L = 0x7B;            // Carrega o valor baixo do numero 57723.
	MOVLW       123
	MOVWF       TMR0L+0 
;main.c,73 :: 		INTCON.TMR0IF = 0;       // Apaga flag de estouro do timer0, pois é fundamental para a sinalização do estouro.
	BCF         INTCON+0, 2 
...
;main.c,79 :: 		if(INTCON.TMR0IF==1){   // Incrementa somente quando existir o overflow do timer 0.
	BTFSS       INTCON+0, 2 
	GOTO        L_main2
;main.c,81 :: 		TMR0H = 0xE1 ;           // Carrega o valor alto do número 57723.
	MOVLW       225
	MOVWF       TMR0H+0 
