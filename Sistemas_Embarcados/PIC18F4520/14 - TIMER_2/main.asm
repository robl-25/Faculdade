...
;main.c,63 :: 		T2CON.T2OUTPS3 = 1;       // Define postscaler 1:16.
	BSF         T2CON+0, 6 
;main.c,64 :: 		T2CON.T2OUTPS2 = 1;       // Define postscaler 1:16.
	BSF         T2CON+0, 5 
;main.c,65 :: 		T2CON.T2OUTPS1 = 1;       // Define postscaler 1:16.
	BSF         T2CON+0, 4 
;main.c,66 :: 		T2CON.T2OUTPS0 = 1;       // Define postscaler 1:16.
	BSF         T2CON+0, 3 
;main.c,67 :: 		T2CON.T2CKPS1  = 1;       // Define prescaler 1:16.
	BSF         T2CON+0, 1 
;main.c,68 :: 		T2CON.T2CKPS0  = 1;       // Define prescaler 1:16.
	BSF         T2CON+0, 0 
;main.c,71 :: 		TMR2 = 0xFF;           // Carrega o valor alto do número 255.
	MOVLW       255
	MOVWF       TMR2+0 
...
;main.c,74 :: 		T2CON.TMR2ON = 1;      // Liga timer2.
	BSF         T2CON+0, 2 
;main.c,76 :: 		while(1){              // Aqui definimos uma condição sempre verdadeira como parametro, portanto todo o bloco será repetido indefinidamente.
L_main0:
;main.c,79 :: 		if(PIR1.TMR2IF==1){       // Incrementa somente quando existir o overflow do timer 2.
	BTFSS       PIR1+0, 1 
	GOTO        L_main2
;main.c,81 :: 		TMR2 = 0xFF;           // Carrega o valor alto do número 256.
	MOVLW       255
	MOVWF       TMR2+0 
;main.c,83 :: 		PIR1.TMR2IF = 0;       // Limpa o flag de estouro do timer0 para uma nova contagem de tempo.
	BCF         PIR1+0, 1 
