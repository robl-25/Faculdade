...
decl           : var_decl {$$ = $1;}
               | fun_decl {$$ = $1;}
               ;
var_decl       : tipo_esp identificador SEMI
                 { $$ = $1;
                   $$->child[0] = $2;
                   $2->nodekind = StmtK;
                   $2->kind.stmt = VariavelK;
                 }
               | tipo_esp identificador LCOLCHETE numero RCOLCHETE SEMI
                 { $$ = $1;
                   $$->child[0] = $2;
                   $2->nodekind = StmtK;
                   $2->kind.stmt = VetorK;
...
tipo_esp       : INT { $$ = newExpNode(TipoK);
	           ...
	           ;
fun_decl       : tipo_esp identificador LPAREN params RPAREN composto_decl
                 { $$ = $1;
                   $$->child[0] = $2;
                   $2->nodekind = StmtK;
                   $2->kind.stmt = FuncaoK;
